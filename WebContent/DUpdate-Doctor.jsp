...
<link rel="stylesheet" type="text/css" href="assets/CSS/profile-doctor-data-style.css">
  <style type="text/css">
    ...
    {
       color:white;
       background-color:rgb(29, 176, 189); ;
    }
  </style>
</head>
<body>
<div class="head">
       <div class="container">
       	   <p class="font-weight-normal text-light">Update Profile</p>
...
<%
    ...
    %>
         <div class="row rowspace">
      	          <div class="col-xl-2">  
      	             <label for="d-id" class="text-label">Doctor Id</label> 	      	     
      	         </div>
      	         <div class="col-xl-4"> 
	  	           	  <input type="text" name="d-id" value="<%=rs.getString("did")%>" class="form-textbox form-control">	 	
      	         </div>	  
      	         <div class="col-xl-2">  
