...
<div class="head">
       <div class="container">
       	   <p class="font-weight-normal text-light">Search Patients </p>
...
<div class="row rowspace">
      	        ...
      	        <div class="col-xl-4">  
                       ...
                       <button class="btn-lg bt-home"><a href="RAdd-Patient-Home.html">Home</a></button>
                       <button class="btn-lg bt-back"><a href="RSearch-Patient.html">Back</a></button>
                </div>
     </div>
      <div class="row rowspace">
      	         <div class="col-xl-2">  
