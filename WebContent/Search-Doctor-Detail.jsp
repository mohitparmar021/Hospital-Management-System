...
<link rel="stylesheet" type="text/css" href="assets/CSS/search-receptionist-Detail-style.css">
<title>Search Doctor</title>
</head>
<body>
<div class="head">
       <div class="container">
       	   <p class="font-weight-normal text-light">Search Doctor</p>
	   ...
	   %>
	    	<div class="row rowspace">
      	         ...
      	         <div class="col-xl-4"> 
      	          ...
      	          <button class="btn-sm bt-back"><a href="Search-Doctor.html">Back</a></button>	 
      	         </div>
