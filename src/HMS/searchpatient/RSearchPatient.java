...
/**
 * Servlet implementation class RSearchPatient
 */
@WebServlet("/RSearchPatient")
public class RSearchPatient extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public RSearchPatient() {
        super();
		...
		if(pid!=null)
		{
			...
			try
			{
				...
				if(rs!=null)
				{
					...
					RequestDispatcher rd=request.getRequestDispatcher("RSearch-Patient-Detail.jsp");
