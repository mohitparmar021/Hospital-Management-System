...
/**
 * Servlet implementation class UpdatePatientDetail
 */
@WebServlet("/UpdatePatientDetail")
public class UpdatePatientDetail extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try
		{
		    ...
		    RequestDispatcher rd=request.getRequestDispatcher("Update-Patient-Success.jsp");
